...
async function loadAirTempData() {
    let retries = 3;
    const apiUrl = 'https://api.globe.gov/search/v1/measurement/protocol/measureddate/polygon/geojson/?protocols=air_temps&startdate=1995-01-01&enddate=2024-01-01&coordinates=%5B-80.65%2C28.57%5D%2C%5B-85.65%2C34.57%5D%2C%5B-80.65%2C34.57%5D%2C%5B-86.65%2C28.57%5D&geojson=TRUE&sample=TRUE';
